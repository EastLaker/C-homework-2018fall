...
namespace ordertest {
    ...
    public class Order {
        ...
        public Order(uint orderId, Customer customer) {
            String s1=System.DateTime.Today.Year.ToString()+ System.DateTime.Today.Month.ToString()+ System.DateTime.Today.Day.ToString();
            String s2=String.Format("{0:000}", orderId);
            Id = s1+s2;
            Customer = customer;
        }
