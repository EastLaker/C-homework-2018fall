...
namespace OrderForm
{
    public partial class FormEdit : Form
    {
        ...
        {
            InitializeComponent();
            Customer customer1 = new Customer(1, "jack ma");
            Customer customer2 = new Customer(2, "pony ma");

            Goods xbox = new Goods(3, "xbox", 1234.5);
            Goods ps4 = new Goods(2, "ps4", 2999.9);
            Goods ps4pro = new Goods(1, "ps4pro", 3599.9);
            customerBindingSource.Add(customer1);
            customerBindingSource.Add(customer2);
            goodsBindingSource.Add(xbox);
            goodsBindingSource.Add(ps4);
            goodsBindingSource.Add(ps4pro);
