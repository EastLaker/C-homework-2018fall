...
namespace OrderConsole
{
    ...
    public class OrderService :Order
    {
        ...
        public List<OrderDetails> myOrderDetail;
        public OrderService()
        {
        ...
        {
            myOrderDetail = service.myOrderDetail;
        }
        public void AddOrder()
        {
            
            OrderDetails newOrder = new OrderDetails(0);
        ...
        public void ChangeOrder(int index)
        {
            ...
            {
                myOrderDetail.RemoveAt(index);
                myOrderDetail.Insert(index, new OrderDetails(0)) ;
        ...
        public void Import(TextReader reader)
        {
            ...
            this.myOrderDetail = temp.myOrderDetail;
